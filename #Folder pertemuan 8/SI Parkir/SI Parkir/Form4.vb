...
Public Class formUtama
    Sub RefreshGrid()
        ...
        Dim sql As String = "select * from tblparkir"
        ...
        If myDataReader.HasRows Then
            While myDataReader.Read()
                ...
                dgvKendaraanParkir.Item(5, i).Value = myDataReader("user")
                i = i + 1
            End While
        End If
    ...
    Private Sub DeleteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DeleteToolStripMenuItem.Click
        If MessageBox.Show("Delete this record?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
            Dim sql As String = "DELETE FROM tblparkir WHERE `user` = '" & dgvKendaraanParkir.CurrentRow.Cells(5).Value.ToString & "'"
            MsgBox(sql)
            If myConn.State = ConnectionState.Closed Then
                myConn.Open()
            End If
